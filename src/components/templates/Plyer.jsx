...
const Plyer = () => {
  ...
  return ytvideo ? (
    <div className="absolute top-0 left-0 bg-gradient-to-br from-gray-900 via-[#0f0f0f] to-gray-900 text-white w-screen h-screen flex items-center justify-center">
      <Link
