...
export const Popular = () => {
  ...
  document.title = "lmovies - Popular " + category.toUpperCase();
  ...
  return popular.length > 0 ? (
    <div className="w-screen h-screen bg-[#303030] pt-16"> {/* Added padding-top to account for topnav height */}
      ...
      {/* Infinite Scroll for Popular Items */}
      <InfiniteScroll
